...
def get_config(cosmos_config_container=None):
    ...
    config = {
        ...
        "deepseek_doc_ai_endpoint": os.getenv("DEEPSEEK_DOC_AI_ENDPOINT", None),
        "deepseek_doc_ai_key": os.getenv("DEEPSEEK_DOC_AI_KEY", None),
        "deepseek_doc_ai_model": os.getenv("DEEPSEEK_DOC_AI_MODEL", "deepseek-v4-pro"),
